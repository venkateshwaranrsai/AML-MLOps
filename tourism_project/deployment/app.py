...
number_of_person_visiting = st.number_input("# of Persons Visiting", min_value=1, max_value=10, value=1)
number_of_followups = st.number_input("# of Follow-ups", min_value=0, max_value=10, value=3)
number_of_trips = st.number_input("# of Trips (annual)", min_value=0, max_value=50, value=5)
...
number_of_children_visiting = st.number_input("# of Children Visiting", min_value=0, max_value=5, value=0)
